...
const CLEANUP_STATE_KEY = Symbol.for("Selfer.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("Selfer.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("Selfer.sessionWriteLockWatchdogState");
