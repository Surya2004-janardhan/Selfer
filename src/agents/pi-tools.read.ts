...
function resolveAdaptiveReadMaxBytes(options?: SelferReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createSelferReadTool(base, {
...
export function createSelferReadTool(
  base: AnyAgentTool,
  options?: SelferReadToolOptions,
): AnyAgentTool {
