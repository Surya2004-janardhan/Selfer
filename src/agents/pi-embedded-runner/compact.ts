...
import { ensureSelferModelsJson } from "../models-config.js";
...
import { createSelferCodingTools } from "../pi-tools.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  await ensureSelferModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createSelferCodingTools({
      exec: {
