...
export type RunCronAgentTurnResult = {
   ...
   * messages.  See: https://github.com/Selfer/Selfer/issues/15692
   */
  delivered?: boolean;
  /**
...
export async function runCronIsolatedAgentTurn(params: {
  ...
  const isFastTestEnv = process.env.Selfer_TEST_FAST === "1";
  ...
  // correct per-agent paths (e.g. ~/.Selfer/agents/<agentId>/agent/).
  ...
  const cfgWithAgentDefaults: SelferConfig = {
    ...params.cfg,
      ...
      const fallbackResult = await runWithModelFallback({
        ...
        run: async (providerOverride, modelOverride, runOptions) => {
          ...
          if (isCliProvider(providerOverride, cfgWithAgentDefaults)) {
            ...
            // the configured timeoutSeconds. See: https://github.com/Selfer/Selfer/issues/29774
