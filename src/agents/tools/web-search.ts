...
type WebSearchConfig = NonNullable<SelferConfig["tools"]>["web"] extends infer Web
...
function resolveSearchConfig(cfg?: SelferConfig): WebSearchConfig {
...
function missingSearchKeyPayload(provider: (typeof SEARCH_PROVIDERS)[number]) {
  ...
  return {
    ...
    message: `web_search needs a Brave Search API key. Run \`${formatCliCommand("Selfer configure --section web")}\` to store it, or set BRAVE_API_KEY in the Gateway environment.`,
    docs: "https://docs.Selfer.ai/tools/web",
  };
}
  ...
  return withTrustedWebSearchEndpoint(
    {
      ...
      init: {
        ...
        headers: {
          ...
          "HTTP-Referer": "https://Selfer.ai",
          "X-Title": "Selfer Web Search",
        },
