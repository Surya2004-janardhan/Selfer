...
export function hasAmbiguousGatewayAuthModeConfig(cfg: SelferConfig): boolean {
...
export function assertExplicitGatewayAuthModeWhenBothConfigured(cfg: SelferConfig): void {
