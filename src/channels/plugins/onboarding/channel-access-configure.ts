...
export async function configureChannelAccessWithAllowlist<TResolved>(params: {
  ...
  setPolicy: (cfg: SelferConfig, policy: ChannelAccessPolicy) => SelferConfig;
  resolveAllowlist: (params: { cfg: SelferConfig; entries: string[] }) => Promise<TResolved>;
  applyAllowlist: (params: { cfg: SelferConfig; resolved: TResolved }) => SelferConfig;
