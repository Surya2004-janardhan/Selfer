...
function resolveAnthropicDefaultAuthMode(cfg: SelferConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: SelferConfig): SelferConfig {
...
export function applyTalkApiKey(config: SelferConfig): SelferConfig {
...
export function applyTalkConfigNormalization(config: SelferConfig): SelferConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: SelferConfig): SelferConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: SelferConfig): SelferConfig {
...
export function applyLoggingDefaults(cfg: SelferConfig): SelferConfig {
...
export function applyContextPruningDefaults(cfg: SelferConfig): SelferConfig {
...
export function applyCompactionDefaults(cfg: SelferConfig): SelferConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
