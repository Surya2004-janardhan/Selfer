...
export function resolveSessionToolsVisibility(cfg: SelferConfig): SessionToolsVisibility {
...
export function resolveSandboxSessionToolsVisibility(cfg: SelferConfig): "spawned" | "all" {
...
export function createAgentToAgentPolicy(cfg: SelferConfig): AgentToAgentPolicy {
