...
import { type SelferConfig, loadConfig } from "../config/config.js";
...
function listConfiguredAgentIds(cfg: SelferConfig): string[] {
...
export function listAgentsForGateway(cfg: SelferConfig): {
  defaultId: string;
  mainKey: string;
  scope: SessionScope;
...
function resolveDefaultStoreAgentId(cfg: SelferConfig): string {
...
function resolveSessionStoreAgentId(cfg: SelferConfig, canonicalKey: string): string {
...
export function loadCombinedSessionStoreForGateway(cfg: SelferConfig): {
  storePath: string;
  store: Record<string, SessionEntry>;
} {
...
export function getSessionDefaults(cfg: SelferConfig): GatewaySessionsDefaults {
