...
export function createAccountListHelpers(channelKey: string) {
  function resolveConfiguredDefaultAccountId(cfg: SelferConfig): string | undefined {
  ...
  function listAccountIds(cfg: SelferConfig): string[] {
  ...
  function resolveDefaultAccountId(cfg: SelferConfig): string {
