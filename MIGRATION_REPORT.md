...
Generated at: 2026-04-15T17:18:15.850Z

## Summary

- Auto-generated compatibility stubs: 127
...
- src-reference/entrypoints/sdk/controlTypes.js
- src-reference/entrypoints/sdk/coreTypes.generated.js
- src-reference/entrypoints/sdk/runtimeTypes.js
- src-reference/entrypoints/sdk/sdkUtilityTypes.js
- src-reference/entrypoints/sdk/settingsTypes.generated.js
- src-reference/entrypoints/sdk/toolTypes.js
...
- src-reference/query/transitions.js
...
- src-reference/tools/CtxInspectTool/CtxInspectTool.js
- src-reference/tools/DiscoverSkillsTool/prompt.js
- src-reference/tools/ListPeersTool/ListPeersTool.js
- src-reference/tools/MonitorTool/MonitorTool.js
- src-reference/tools/OverflowTestTool/OverflowTestTool.js
- src-reference/tools/PushNotificationTool/PushNotificationTool.js
- src-reference/tools/REPLTool/REPLTool.js
- src-reference/tools/ReviewArtifactTool/ReviewArtifactTool.js
- src-reference/tools/SendUserFileTool/SendUserFileTool.js
- src-reference/tools/SendUserFileTool/prompt.js
- src-reference/tools/SleepTool/SleepTool.js
- src-reference/tools/SnipTool/SnipTool.js
- src-reference/tools/SnipTool/prompt.js
- src-reference/tools/SubscribePRTool/SubscribePRTool.js
- src-reference/tools/SuggestBackgroundPRTool/SuggestBackgroundPRTool.js
- src-reference/tools/TerminalCaptureTool/TerminalCaptureTool.js
- src-reference/tools/TerminalCaptureTool/prompt.js
- src-reference/tools/TungstenTool/TungstenLiveMonitor.js
- src-reference/tools/TungstenTool/TungstenTool.js
- src-reference/tools/VerifyPlanExecutionTool/VerifyPlanExecutionTool.js
- src-reference/tools/VerifyPlanExecutionTool/constants.js
- src-reference/tools/WebBrowserTool/WebBrowserPanel.js
- src-reference/tools/WebBrowserTool/WebBrowserTool.js
- src-reference/tools/WorkflowTool/WorkflowPermissionRequest.js
- src-reference/tools/WorkflowTool/WorkflowTool.js
- src-reference/tools/WorkflowTool/bundled/index.js
- src-reference/tools/WorkflowTool/constants.js
- src-reference/tools/WorkflowTool/createWorkflowCommand.js
- src-reference/types/connectorText.js
- src-reference/types/fileSuggestion.js
- src-reference/types/message.js
- src-reference/types/messageQueueTypes.js
- src-reference/types/notebook.js
- src-reference/types/statusLine.js
- src-reference/types/tools.js
- src-reference/types/utils.js
