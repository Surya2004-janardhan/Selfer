...
import { discoverSelferPlugins } from "../../plugins/discovery.js";
import type { SelferPackageManifest } from "../../plugins/manifest.js";
...
const ENV_CATALOG_PATHS = ["SELFER_PLUGIN_CATALOG_PATHS", "SELFER_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<SelferPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: SelferPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: SelferPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoverSelferPlugins({ workspaceDir: options.workspaceDir });
