...
function resolveAcpStreamCoalesceIdleMs(cfg: SelferConfig): number {
...
function resolveAcpStreamMaxChunkChars(cfg: SelferConfig): number {
...
export function resolveAcpProjectionSettings(cfg: SelferConfig): AcpProjectionSettings {
