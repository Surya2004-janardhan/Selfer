...
import { loadSelferPlugins } from "./loader.js";
import { createPluginLoaderLogger } from "./logger.js";
import type { SelferPluginToolContext } from "./types.js";
...
export function resolvePluginTools(params: {
  context: SelferPluginToolContext;
  ...
  const registry = loadSelferPlugins({
