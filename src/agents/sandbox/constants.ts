...
export const DEFAULT_SANDBOX_IMAGE = "Selfer-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "Selfer-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "Selfer-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "Selfer-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "Selfer-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "Selfer-sandbox-browser";
