...
function resolveResolutionLimits(config: SelferConfig): ResolutionLimits {
...
function resolveConfiguredProvider(ref: SecretRef, config: SelferConfig): SecretProviderConfig {
