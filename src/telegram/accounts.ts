...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.Selfer_DEBUG_TELEGRAM_ACCOUNTS)) {
...
function listConfiguredAccountIds(cfg: SelferConfig): string[] {
...
export function listTelegramAccountIds(cfg: SelferConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: SelferConfig): string {
...
function mergeTelegramAccountConfig(cfg: SelferConfig, accountId: string): TelegramAccountConfig {
  const {
    accounts: _ignored,
  ...
  // See: https://github.com/Selfer/Selfer/issues/30673
...
export function listEnabledTelegramAccounts(cfg: SelferConfig): ResolvedTelegramAccount[] {
