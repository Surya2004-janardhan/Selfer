...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.Selfer.ai/automation/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("Selfer hooks list")}`,
      `  ${formatCliCommand("Selfer hooks enable <name>")}`,
      `  ${formatCliCommand("Selfer hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
