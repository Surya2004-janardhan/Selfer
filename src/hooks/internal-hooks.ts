/**
 * Hook system for Selfer agent events
 *
...
const _g = globalThis as typeof globalThis & {
  __Selfer_internal_hook_handlers__?: Map<string, InternalHookHandler[]>;
};
const handlers = (_g.__Selfer_internal_hook_handlers__ ??= new Map<
  string,
  InternalHookHandler[]
>());
