...
export type ChannelConfigAdapter<ResolvedAccount> = {
  listAccountIds: (cfg: SelferConfig) => string[];
  resolveAccount: (cfg: SelferConfig, accountId?: string | null) => ResolvedAccount;
  inspectAccount?: (cfg: SelferConfig, accountId?: string | null) => unknown;
  defaultAccountId?: (cfg: SelferConfig) => string;
  setAccountEnabled?: (params: {
    cfg: SelferConfig;
    accountId: string;
    enabled: boolean;
  }) => SelferConfig;
  deleteAccount?: (params: { cfg: SelferConfig; accountId: string }) => SelferConfig;
  isEnabled?: (account: ResolvedAccount, cfg: SelferConfig) => boolean;
  disabledReason?: (account: ResolvedAccount, cfg: SelferConfig) => string;
  isConfigured?: (account: ResolvedAccount, cfg: SelferConfig) => boolean | Promise<boolean>;
  unconfiguredReason?: (account: ResolvedAccount, cfg: SelferConfig) => string;
  describeAccount?: (account: ResolvedAccount, cfg: SelferConfig) => ChannelAccountSnapshot;
...
export type ChannelGatewayContext<ResolvedAccount = unknown> = {
   ...
   * @see {@link https://docs.Selfer.ai/plugins/developing-plugins | Plugin SDK documentation}
   */
...
export type ChannelHeartbeatAdapter = {
  ...
  resolveRecipients?: (params: { cfg: SelferConfig; opts?: { to?: string; all?: boolean } }) => {
    recipients: string[];
    source: string;
  };
};
