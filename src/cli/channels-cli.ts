    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["selfer channels list", "List configured channels and auth profiles."],
          ["selfer channels status --probe", "Run channel status checks and probes."],
          [
            "selfer channels add --channel telegram --token <token>",
            "Add or update a channel account non-interactively.",
          ],
          ["selfer channels login --channel whatsapp", "Link a WhatsApp Web account."],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/channels",
          "docs.selfer.ai/cli/channels",
        )}\n`,
    );
