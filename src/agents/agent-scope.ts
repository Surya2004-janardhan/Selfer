...
type AgentEntry = NonNullable<NonNullable<SelferConfig["agents"]>["list"]>[number];
...
export function listAgentEntries(cfg: SelferConfig): AgentEntry[] {
...
export function listAgentIds(cfg: SelferConfig): string[] {
...
export function resolveDefaultAgentId(cfg: SelferConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
function resolveAgentEntry(cfg: SelferConfig, agentId: string): AgentEntry | undefined {
...
export function resolveAgentModelPrimary(cfg: SelferConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: SelferConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: SelferConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
