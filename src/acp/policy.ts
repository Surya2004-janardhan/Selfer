...
export function isAcpEnabledByPolicy(cfg: SelferConfig): boolean {
  return cfg.acp?.enabled !== false;
}

export function resolveAcpDispatchPolicyState(cfg: SelferConfig): AcpDispatchPolicyState {
...
export function isAcpDispatchEnabledByPolicy(cfg: SelferConfig): boolean {
  return resolveAcpDispatchPolicyState(cfg) === "enabled";
}

export function resolveAcpDispatchPolicyMessage(cfg: SelferConfig): string | null {
...
export function resolveAcpDispatchPolicyError(cfg: SelferConfig): AcpRuntimeError | null {
...
export function isAcpAgentAllowedByPolicy(cfg: SelferConfig, agentId: string): boolean {
