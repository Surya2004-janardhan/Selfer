...
function resolveDefaultAccountId(cfg: SelferConfig, provider: ChannelId): string {
...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: SelferConfig): boolean {
...
export function summarizeBindings(cfg: SelferConfig, bindings: AgentBinding[]): string[] {
