    ...
    .addHelpText(
      ...
      () =>
        `\n${theme.heading("Examples:")}\n${formatHelpExamples([
          ["selfer directory self --channel slack", "Show the connected account identity."],
          [
            'selfer directory peers list --channel slack --query "alice"',
            "Search contact/user IDs by name.",
          ],
          ["selfer directory groups list --channel discord", "List available groups/channels."],
          [
            "selfer directory groups members --channel discord --group-id <id>",
            "List members for a specific group.",
          ],
        ])}\n\n${theme.muted("Docs:")} ${formatDocsLink(
          "/cli/directory",
          "docs.selfer.ai/cli/directory",
        )}\n`,
    )
    .action(() => {
