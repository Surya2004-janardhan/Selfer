...
function resolveAvatarSource(cfg: SelferConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: SelferConfig, agentId: string): AgentAvatarResolution {
