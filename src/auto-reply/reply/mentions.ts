...
function resolveMentionPatterns(cfg: SelferConfig | undefined, agentId?: string): string[] {
  if (!cfg) {
    return [];
  }
...
export function buildMentionRegexes(cfg: SelferConfig | undefined, agentId?: string): RegExp[] {
