...
function resolveMemoryToolContext(options: { config?: SelferConfig; agentSessionKey?: string }) {
...
function resolveMemoryCitationsMode(cfg: SelferConfig): MemoryCitationsMode {
