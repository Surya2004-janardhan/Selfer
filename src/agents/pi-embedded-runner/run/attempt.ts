...
import { resolveSelferAgentDir } from "../../agent-paths.js";
...
import { resolveSelferDocsPath } from "../../docs-path.js";
...
import { createSelferCodingTools, resolveToolLoopDetectionConfig } from "../../pi-tools.js";
...
export async function runEmbeddedAttempt(
  ...
  try {
    ...
    const agentDir = params.agentDir ?? resolveSelferAgentDir();
    ...
    const docsPath = await resolveSelferDocsPath({
      workspaceDir: effectiveWorkspace,
    ...
    try {
      ...
      try {
        ...
        // double-compaction. See: https://github.com/Selfer/Selfer/issues/9282
        ...
        if (promptError && promptErrorSource === "prompt" && !compactionOccurredThisAttempt) {
          try {
            sessionManager.appendCustomEntry("Selfer:prompt-error", {
              timestamp: Date.now(),
              runId: params.runId,
              sessionId: params.sessionId,
              provider: params.provider,
      ...
      // See: https://github.com/Selfer/Selfer/issues/8643
