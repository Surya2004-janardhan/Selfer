...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof SelferConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: SelferConfig; env: NodeJS.ProcessEnv }): {
  cfg: SelferConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
