...
export function listBindings(cfg: SelferConfig): AgentRouteBinding[] {
...
export function listBoundAccountIds(cfg: SelferConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: SelferConfig) {
